...
func TestCoinDynamicPrograming(t *testing.T) {
	assert.Equal(t, 0, coinDynamicPrograming([]int{1}, 0))
	assert.Equal(t, -1, coinDynamicPrograming([]int{2}, 3))
	assert.Equal(t, 2, coinDynamicPrograming([]int{1, 2, 5}, 6))
	assert.Equal(t, -1, coinDynamicPrograming([]int{4, 5}, 11))
	assert.Equal(t, 20, coinDynamicPrograming([]int{1, 2, 5}, 100))
	assert.Equal(t, 20, coinDynamicPrograming([]int{186, 419, 83, 408}, 6249))
	assert.Equal(t, 3, coinDynamicPrograming([]int{1, 5, 10, 21, 25}, 63))
	assert.Equal(t, 2, coinDynamicPrograming([]int{2, 3, 4}, 6))
}
